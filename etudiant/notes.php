...
if (isset($_SESSION["connected"]) && isset($_SESSION["role"]) && $_SESSION["role"] === "etudiant") {
  ...
  $stmt = $pdo->prepare("select note_id, element_nom, note_avant_ratt, note_apres_ratt from notes, elements where element_id = note_element and note_etudiant =?");
