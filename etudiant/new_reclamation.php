...
if (isset($_SESSION["connected"]) && isset($_SESSION["role"]) && $_SESSION["role"] === "etudiant") {
  ...
  $stmtProfesseurs = $pdo->prepare("SELECT * FROM professeurs");
  $stmtProfesseurs->execute();

  $stmtElements = $pdo->prepare("SELECT * FROM elements");
  $stmtElements->execute();
} else {
...
<head>
  ...
  <title>Etudiant - Envoyer une Reclamation</title>
      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown active">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdown01">
            <a class="dropdown-item" href="#">Nouvelle Reclamation</a>
    ...
    <div class="row">
      ...
      <div class="col-8">
        <div id="info-wrapper" class="pt-5">
          <div class="card">
            <h3 class="card-title text-center p-4">Reclamer une Copie</h3>
            <?php
            if ($success) {
              ?>
            <div class="pl-5 pr-5">
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                <strong></strong> La reclamation a été envoyée.
            ...
            <div class="card-body p-5">
              <form method="POST" action="../controllers/etudiant_new_reclamation.php">

                <div class="row">
                  <div class="col-1"></div>
                  <div class="col-4">
                    <label for="element">Element de Module</label>
                  </div>
                ...
                <div class="row mt-5 mb-4">
                  <div class="col">
                    <input type="submit" href="../controllers/etudiant_new_reclamation.php" class="btn btn-outline-secondary"
                      id="profile-update-button" role="button" value="Send" />
                  </div>
                </div>
              </form>
            </div>
