        ...
        <div id="info-wrapper" class="pt-5">
          <div class="card">
            ...
            <div class="card-body p-5">
              ...
              <div class="row mt-4">
                <div class="col-3"></div>
                <div class="col-4">Filiere</div>
                <div class="col"><?= $_SESSION["filiere"] ?></div>
              </div>
              <div class="row mt-4">
                <div class="col-3"></div>
                <div class="col-4">CIN</div>
                <div class="col"><?= $_SESSION["cin"] ?></div>
              </div>
              <div class="row mt-4">
                <div class="col-3"></div>
                <div class="col-4">CNE</div>
                <div class="col"><?= $_SESSION["cne"] ?></div>
              </div>
              <div class="row mt-4">
                <div class="col-3"></div>
                <div class="col-4">Date de Naissance</div>
                <div class="col"><?= $_SESSION["date"] ?></div>
              </div>
