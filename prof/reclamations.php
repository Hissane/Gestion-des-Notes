...
if (isset($_SESSION["connected"]) && isset($_SESSION["role"]) && $_SESSION["role"] === "prof") {
  ...
  $stmt = $pdo->prepare("select rec.reclamation_id, et.etudiant_nom, et.etudiant_prenom, el.element_nom, rec.reclamation_desc from etudiants et, elements el, reclamations rec where rec.element_id = el.element_id and rec.etudiant_id=et.etudiant_id and el.element_responsable_id =?");
    ...
    <div class="row">
      ...
      <div class="col-8">
        <div id="info-wrapper" class="pt-5">
          <div class="card">
            <h3 class="card-title text-center p-4">Reclamations</h3>
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="./repondre_reclamation.php?reclamation=<?=$row['reclamation_id']?>" >Repondre</a></td>
                  </tr>
                <?php } ?>
                </tbody>
              </table>
