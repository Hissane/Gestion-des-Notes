...
<head>
  ...
  <title>Professeur - Modifier profil</title>
                ...
                <div class="row mt-4">
                  ...
                  <div class="col">
                    <input type="text" class="form-control" name="departement" id="departement" placeholder="" required
                      value="<?= $_SESSION["departement"] ?>" />
                  </div>
                  <div class="col-1"></div>
                </div>
                <div class="row mt-5 mb-4">
                  <div class="col">
                    <input type="submit" href="../controllers/prof_profile_update.php" class="btn btn-outline-secondary"
