...
<head>
  ...
  <title>Administrateur - Modifier profil</title>
        ...
        <div id="info-wrapper" class="pt-5">
          ...
          ?>
            <div class="card-body p-5">
              <form method="POST" action="../controllers/admin_profile_update.php">
                <div class="row">
                  <div class="col-1"></div>
                  <div class="col-4">
                ...
                <div class="row mt-5 mb-4">
                  <div class="col">
                    <input type="submit" href="../controllers/admin_profile_update.php" class="btn btn-outline-secondary"
