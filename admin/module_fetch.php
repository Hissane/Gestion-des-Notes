...
<head>
  ...
  <title>Administrateur - Ajouter Module</title>
    ...
    <div class="collapse navbar-collapse" id="navbar">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown active">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdown01">
            <a class="dropdown-item" href="#">Ajouter Module</a>
    ...
    <div class="row">
      ...
      <div class="col-8">
        <div id="info-wrapper" class="pt-5">
          <div class="card">
            <h3 class="card-title text-center p-4">Ajouter un module</h3>
            <?php
            if ($error) {
              ?>
            <div class="pl-5 pr-5">
          ...
          ?>
            <div class="card-body p-5">
              <form method="POST" action="../controllers/admin_module_update.php">
                <div class="row">
                  <div class="col-1"></div>
                  <div class="col-4">
                ...
                <div class="row mt-5 mb-4">
                  <div class="col">
                    <input type="submit" href="../controllers/admin_module_update.php" class="btn btn-outline-secondary"
